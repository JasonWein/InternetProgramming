...
function drawAnimation () {
  ...
  rainingRect.position[1] -= rainingRect.velocity1;
...
function Rectangle () {
  ...
  rect.velocity1 = 1.0 + 6.0*Math.random();
  rect.velocity2 = rect.velocity1;
